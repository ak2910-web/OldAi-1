    ...
    <ScrollView style={styles.container}>
      ...
      <View style={[styles.card, styles.vedicCard]}>
        ...
        <View style={styles.badge}>
          <Text style={styles.badgeText}>🕉 Vedic Mathematics</Text>
        </View>
      </View>
      ...
      <View style={[styles.card, styles.modernCard]}>
        ...
        <View style={styles.badge}>
          <Text style={styles.badgeText}>🔬 {mathematicalField}</Text>
        </View>
      </View>
      ...
      <View style={styles.footer}>
        <Text style={styles.footerText}>
          ℹ️ This mapping is generated by Ataravanavira's cross-domain inference engine
        </Text>
      </View>
    </ScrollView>
  );
